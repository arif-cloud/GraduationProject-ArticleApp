...
class GetArticleState @Inject constructor(
    private val articleRepository: ArticleRepository,
    private val firebaseRepository: FirebaseRepository
) {
    suspend operator fun invoke(articleId : Int) : ArticleStateResponse {
        return articleRepository.getArticleState(articleId, firebaseRepository.getUserId())
    }
}